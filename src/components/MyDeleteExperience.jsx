...
import { fetchDeleteExpAction } from "../redux/actions/fetchEditExperience";
import { Button, Modal } from "react-bootstrap";

function MyDeleteExperience({ expData, show, handleClose }) {
...
export default MyDeleteExperience;
