    ...
    <Card border="secondary">
      ...
      <Card.Body>
        <Card.Text>
          <Row>
            <Col xs={3}>
              <a href="#" className="text-center text-decoration-none-only">
                <div className="d-flex flex-column align-items-center">
                  <svg
                    ...
                    height="40"
                    focusable="false"
                    className="border border-1 rounded-2 offcanvasButtonHover mx-3"
                  >
                    <defs>
                      <linearGradient
                        id="app-learning-@1-a"
                  ...
                  <p className="fs-7 text-secondary ">Learning</p>
                </div>
              </a>
            </Col>
            {/* //----------------------------------------------------- */}
            <Col xs={3}>
              <a href="#" className="text-center text-decoration-none-only">
                <div className="d-flex flex-column align-items-center">
                  ...
                  <p className="fs-7 text-secondary ">Talent Insights</p>
                </div>
              </a>
            </Col>
            {/* //----------------------------------------------------------------------- */}
            <Col xs={3}>
              <a href="#" className="text-center text-decoration-none-only">
                <div className="d-flex flex-column align-items-center">
                  ...
                  <p className="fs-7 text-secondary ">Pubblica un'offerta di lavoro</p>
                </div>
              </a>
            </Col>
            {/* //----------------------------------------------------------------------------- */}
            <Col xs={3}>
              <a href="#" className="text-center text-decoration-none-only">
                <div className="d-flex flex-column align-items-center">
                  ...
                  <p className="fs-7 text-secondary ">Pubblicizza</p>
                </div>
              </a>
            </Col>
            {/* -------------------------------------------------------------------------------------------- */}
            <Col xs={3}>
              <a href="#" className="text-center text-decoration-none-only">
                <div className="d-flex flex-column align-items-center">
                  ...
                  <p className="fs-7 text-secondary ">Trova lead</p>
                </div>
              </a>
            </Col>
            {/* ----------------------------------------------------------------------------- */}
            <Col xs={3}>
              <a href="#" className="text-center text-decoration-none-only">
                <div className="d-flex flex-column align-items-center">
                  ...
                  <p className="fs-7 text-secondary ">Gruppi</p>
                </div>
              </a>
            </Col>
            {/* ------------------------------------------------------------------------------------------ */}
            <Col xs={3}>
              <a href="#" className="text-center text-decoration-none-only">
                <div className="d-flex flex-column align-items-center">
                  ...
                  <p className="fs-7 text-secondary ">Marketplace dei servizi</p>
                </div>
              </a>
            </Col>
          </Row>
